import type { FeedbackPayload, PersistedFeedbackState } from '@web/types'
import { ref } from 'vue'
import { defineStore } from 'pinia'
import analytics from '@web/analytics'
import { STORAGE_KEYS } from '@web/constants/storage.ts'
import { decideFeedbackPrompt, defaultFeedbackState, recordVisitDay, sanitizeFeedbackMessage, toLocalISODate } from '@web/utils/feedback'
import { loadFromStorage, saveToStorage } from '@web/utils/localstorage'
