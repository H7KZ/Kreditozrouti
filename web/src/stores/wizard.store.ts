...
import type { PersistedWizardState, SelectedStudyPlan } from '@web/types'
import { computed, ref } from 'vue'
import { defineStore } from 'pinia'
import { STORAGE_KEYS } from '@web/constants/storage.ts'
import { useCompletedCoursesStore } from '@web/stores/completed-courses.store'
import { useWizardDataStore } from '@web/stores/wizard-data.store'
import { loadFromStorage, removeFromStorage, saveToStorage } from '@web/utils/localstorage'
