import type { CoursesFilter, CoursesResponseDTO, CourseWithRelationsDTO } from '@kreditozrouti/types'
import { computed, ref, watch } from 'vue'
import { defineStore } from 'pinia'
import { i18n } from '@web/i18n'
import { fetchCourses as fetchCoursesFromService } from '@web/services/courseService'
import { useAnnouncerStore } from '@web/stores/announcer.store'
import { useFiltersStore } from '@web/stores/filters.store'
import { useTimetableStore } from '@web/stores/timetable.store'
