...
import type { CourseStatus, CourseUnitType, PersistedTimetableState, SelectedCourseUnit, SlotConflictInfo } from '@web/types'
import { computed, ref, watch } from 'vue'
import { defineStore } from 'pinia'
import analytics from '@web/analytics'
import { STORAGE_KEYS } from '@web/constants/storage.ts'
import { ALL_DAYS } from '@web/constants/timetable'
import { i18n } from '@web/index'
import { useAnnouncerStore } from '@web/stores/announcer.store'
import { useFiltersStore } from '@web/stores/filters.store'
import { useScheduleSlotsStore } from '@web/stores/schedule-slots.store'
import { getSlotType } from '@web/utils/course'
import { getDayFromDate, migrateLegacyDay } from '@web/utils/day'
import { loadFromStorage, removeFromStorage, saveToStorage } from '@web/utils/localstorage.ts'
import { checkCourseCompleteness, unitsCampusConflict, unitsConflict } from '@web/utils/timetable'
