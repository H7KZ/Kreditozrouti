...
import type { CourseStatus } from '@web/types'
import type { FitChip, FitResult } from '@web/composables/useFitScore'
import { fitChipFor } from '@web/composables/useFitScore'
import type { CourseWithRelationsDTO } from '@kreditozrouti/types'
import { computed } from 'vue'
import CourseRowExpanded from '@web/components/courses/CourseRowExpanded.vue'
import CourseStatusIndicator from '@web/components/courses/CourseStatusIndicator.vue'
import { useCourseLabels, useOptimizerBasket, useScheduleSummary } from '@web/composables'
import { useCoursesStore, useTimetableStore } from '@web/stores'
