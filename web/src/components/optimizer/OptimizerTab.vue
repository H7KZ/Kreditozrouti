...
import type { OptimizerResults, OptimizerState, SelectedCourseUnit } from '@web/types'
import { computed, onMounted, ref, watch } from 'vue'
import { useI18n } from 'vue-i18n'
import { useOptimizer, useOptimizerBasket } from '@web/composables'
import { useAlertsStore, useScheduleSlotsStore, useTimetableStore } from '@web/stores'
