import type { CourseStatus, CourseStatusFilterState, CourseStatusType } from '@web/types'
...
export function useCourseStatusFilter() {
	...
	const filterOptions = computed<StatusFilterOption[]>(() => [
		...
		},
		{
			...
			count: timetableStore.conflictGroupCount,
			icon: 'conflict',
		...
		},
		{
			...
			count: timetableStore.campusConflictGroupCount,
			icon: 'conflict',
