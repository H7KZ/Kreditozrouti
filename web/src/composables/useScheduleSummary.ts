import type { CourseUnitDTO, CourseUnitSlotDTO, Day } from '@kreditozrouti/types'
import { useTimeUtils } from '@web/composables/useTimeUtils'
import { DAYS_ORDER } from '@web/constants/timetable.ts'
import { i18n } from '@web/index.ts'
import { getDayFromDate, getDayIndex } from '@web/utils/day.ts'
