...
import CoursesHeader from '@web/components/courses/CoursesHeader.vue'
import CourseStatusSummary from '@web/components/courses/CourseStatusSummary.vue'
import CourseTable from '@web/components/courses/CourseTable.vue'
import MobileBottomNav from '@web/components/common/MobileBottomNav.vue'
import FilterFullScreen from '@web/components/filters/FilterFullScreen.vue'
import FilterPanel from '@web/components/filters/FilterPanel.vue'
import OptimizerTab from '@web/components/optimizer/OptimizerTab.vue'
import ScheduleSlotsPanel from '@web/components/timetable/ScheduleSlotsPanel.vue'
import TimetableGrid from '@web/components/timetable/TimetableGrid.vue'
import { resetCourseStatusFilter } from '@web/composables/useCourseStatusFilter'
import { computeFitScores } from '@web/composables'
import { useCoursesStore, useFiltersStore, useTimetableStore, useUIStore, useWizardStore } from '@web/stores'
			...
			<div class="flex flex-1 flex-col overflow-hidden">
				...
				>
					...
					>
						...
						<button type="button" class="insis-btn-text mt-2" @click="() => coursesStore.fetchCourses()">
							{{ $t('common.tryAgain') }}
						</button>
					</div>
