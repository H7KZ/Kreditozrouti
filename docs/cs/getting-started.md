...
> **Specialita VŠE – známka 4+:** Pokud získáš 50–59 bodů, dostaneš 4+ a máš nárok na jeden opravný pokus zkoušky ještě
> během probíhajícího zkouškového období. Pokud uspěješ (60+ bodů), 4+ se smaže. Pokud neuspěješ nebo pokus nevyužiješ,
> dostaneš 4.
...
Zvol akademický rok, ve kterém jsi začal/a studovat. Pokud si nejsi jistý/á, zkontroluj e-index v InSISu nebo se podívej
na akademický rok prvního zapsaného semestru.

### Krok 3: Vyber studijní plán

Filtruj podle úrovně studia (Bc./Mgr.) nebo vyhledej podle názvu. Klikni na svůj studijní plán. Pokud máš specializaci,
vyber ji.
...
Zobrazí se ti předměty relevantní pro tvůj studijní plán s jejich rozvrhovou akcí, ECTS hodnotami a informacemi o
vyučujícím. Kliknutím na řádek zobrazíš detail.
...
Pohled rozvrhu zobrazuje tvůj týden jako mřížku. Kolize jsou zvýrazněny červeně. Zkontroluj, že nemáš vedle sebe
předměty z různých areálů.
...
Sjeď dolů na skupiny předmětů (oP, oV atd.), rozbal skupinu kliknutím na šipku, zaškrtni předměty a klikni na **Přidat
označené předměty**.
...
U každého předmětu s červenou tečkou klikni ve sloupci **Rozvrh** na odkaz **Vyberte**. Zvol čas přednášky i cvičení a
potvrď tlačítkem **Uložit**.
...
Klikni na **Zobrazení rozvrhů** pro přehled celého týdne. Ujisti se, že žádné dva předměty z různých areálů nejdou hned
za sebou.

InSIS zobrazuje rozvrh jako týdenní mřížku. JM v místnosti = Jižní Město; RB/NB/SB = Žižkov.

> **Nezapomeň:** Kreditožrouti je pouze plánovací nástroj. Dokud se nezapíšeš v InSISu, nemáš předměty úředně zapsané.
