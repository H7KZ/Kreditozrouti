...
VŠE uses the ECTS credit system, recognised across European universities. When you enrol in a bachelor's programme you
receive **216 credit vouchers** (kreditové poukázky). Each course costs vouchers equal to its credit value. Pass the
course and the same number of credits is added to your account. You need **180 earned credits** distributed across the
...
Pick the academic year you started studying. If unsure, check your e-index in InSIS or look at the academic year of your
first enrolled semester.

### Step 3: Select your study plan

Filter by study level (Bachelor's / Master's) or search by name, then click your plan. If your programme has a
specialisation, select it here. Each programme has its own set of mandatory and elective courses.
...
Courses relevant to your study plan appear with their time slots, ECTS values and instructor. Click any row to see
course details. Highlighted rows belong to your study plan. Green = already added to your timetable.
...
The timetable view shows your week as a grid. Conflicts are highlighted in red. Check that no two consecutive classes
are on different campuses.
...
Go to [insis.vse.cz](https://insis.vse.cz), sign in with your VŠE credentials, then click **Portál studenta** (= Student
Portal) in the top navigation.

### Step 2: Open Registrace a zápisy

In the "Aplikace zvoleného studia" section find the three-paw icon and click **Registrace a zápisy** (= Course
...
For each course with a red dot, click **Vyberte** (= Select) in the **Rozvrh** (= Timetable) column. Choose lecture and
...
Click **Zobrazení rozvrhů** (= View timetable) to see your full week. Verify no two back-to-back classes are on
different campuses.

> **Remember:** Kreditožrouti is a planning tool only. Until you complete enrollment in InSIS, you are not officially
