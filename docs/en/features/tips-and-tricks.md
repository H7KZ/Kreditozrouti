---
title: Tips & Tricks
description: Power user tips for getting the most out of Kreditožrouti.
---

# Tips & Tricks

## Drag to Find Free Slots

Instead of manually entering a time restriction in the filter sidebar, draw directly on the timetable grid:

1. Switch to **My Timetable** view.
2. Click and drag across any empty area of the grid.
3. A popover confirms the day and time range you selected.
4. Click **Search courses** — the app switches to Course List view filtered to courses with a slot in that window.

This is the fastest way to answer "what can I add on Tuesday between 9 and 11?"

---

## Share Your Timetable

Send your planned schedule to a classmate or your study group — no account required.

1. Open **My Timetable** view.
...
## Mark Completed Courses to Cut the Noise

Once you've passed a course, mark it so it disappears from your list:
...
- **Required prerequisites** — must have passed these before enrolling
- **Cannot study after** — if you've already passed this course, you can no longer enrol in the target course
- **Cannot study alongside** — cannot take both in the same semester
- **Recommended before** — suggested prior study, not enforced

---

## Use the Wizard to Plan by Faculty and Year
