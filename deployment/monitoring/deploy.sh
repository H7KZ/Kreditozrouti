...
main() {
    ...
    # Trailing dot bypasses the container's broken "search ." resolv.conf entry
    # (Docker always emits this line when there's no search domain, and the
    # busybox/musl resolver behind wget mishandles it — moby/moby#38243).
