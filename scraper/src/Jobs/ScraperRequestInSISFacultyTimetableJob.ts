import type { ScraperInSISFacultyTimetable } from '@kreditozrouti/core/queue'
import type { ScraperInSISFacultyTimetableRequestJob } from '@kreditozrouti/core/queue'
