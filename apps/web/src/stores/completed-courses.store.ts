import type { CourseDTO, InSISStudyPlanCourseCategory, InSISStudyPlanCourseGroup, StudyPlanWithRelationsDTO } from '@kreditozrouti/types'
import { computed, ref } from 'vue'
import { defineStore } from 'pinia'
import { priorityOf } from '@kreditozrouti/core/domain/studyPlan'
import { STORAGE_KEYS } from '@web/constants/storage.ts'
import { useWizardDataStore } from '@web/stores/wizard-data.store'
import { useWizardStore } from '@web/stores/wizard.store'
import { saveToStorage } from '@web/utils/localstorage'
