import type { PersistedScheduleSlotsState, SavedScheduleSlot, SelectedCourseUnit } from '@web/types'
import { computed, ref } from 'vue'
import { defineStore } from 'pinia'
import analytics from '@web/analytics'
import { STORAGE_KEYS } from '@web/constants/storage.ts'
import { useFeedbackStore } from '@web/stores/feedback.store'
import { useTimetableStore } from '@web/stores/timetable.store'
import { migrateLegacyDay } from '@web/utils/day'
import { loadFromStorage, saveToStorage } from '@web/utils/localstorage.ts'
