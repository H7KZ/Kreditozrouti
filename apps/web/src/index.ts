...
import faro from '@web/faro'
import { useAlertsStore, useCoursesStore, useFeedbackStore, useScheduleSlotsStore, useTimetableStore, useUIStore, useWizardStore } from '@web/stores'
