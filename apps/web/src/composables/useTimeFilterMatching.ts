...
import { useTimeUtils } from '@web/composables'
import { useFiltersStore } from '@web/stores'
import { CourseUnitWithSlots } from '@web/types'
import { getSlotDay } from '@web/utils/day.ts'
