...
import CollapsibleSection from '@web/components/common/CollapsibleSection.vue'
import CourseStatusFilter from '@web/components/filters/CourseStatusFilter.vue'
import FilterCheckboxGroup from '@web/components/filters/FilterCheckboxGroup.vue'
import FilterTimeRange from '@web/components/filters/FilterTimeRange.vue'
import { useDebouncedFn } from '@web/composables'
import { useSharedCourseStatusFilter } from '@web/composables/useCourseStatusFilter'
import { useCompletedCoursesStore, useCoursesStore, useFiltersStore, useTimetableStore, useUIStore } from '@web/stores'
