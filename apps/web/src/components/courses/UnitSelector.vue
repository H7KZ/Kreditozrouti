...
import type { CourseUnitWithSlots, SelectedCourseUnit } from '@web/types'
import type { CourseUnitDTO, CourseUnitSlotDTO, CourseWithRelationsDTO } from '@kreditozrouti/types'
import { computed, ref, toRef } from 'vue'
import { useI18n } from 'vue-i18n'
import { useCourseLabels, useCourseUnitSelection, useSlotFormatting, useSlotSorting, useTimeFilterMatching } from '@web/composables'
import { useTimetableStore } from '@web/stores'
