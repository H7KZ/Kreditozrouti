...
import LanguageSwitcher from '@web/components/common/LanguageSwitcher.vue'
import ThemeToggle from '@web/components/common/ThemeToggle.vue'
import { useCourseLabels } from '@web/composables'
import { useFiltersStore, useTimetableStore, useWizardStore } from '@web/stores'
