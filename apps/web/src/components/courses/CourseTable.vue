...
import type { CourseSortBy } from '@web/types'
import type { FitResult } from '@web/composables/useFitScore'
import { computed } from 'vue'
import { useI18n } from 'vue-i18n'
import CourseRow from '@web/components/courses/CourseRow.vue'
...
import { useCourseLabels, useScheduleSummary } from '@web/composables'

import { useCoursesStore, useFiltersStore, useTimetableStore } from '@web/stores'
