...
import type { MergedUnit } from '@web/composables'
import { isMergedUnit, useCourseLabels, useScheduleExport, useShareTimetable, useSlotMerging, useTimetableDrag, useTimetableGrid } from '@web/composables'
import type { SelectedCourseUnit } from '@web/types'
import type { Day } from '@kreditozrouti/types'
import { computed, ref, toRef } from 'vue'
import { useI18n } from 'vue-i18n'
import TimetableAgenda from '@web/components/timetable/TimetableAgenda.vue'
import TimetableCourseBlock from '@web/components/timetable/TimetableCourseBlock.vue'
import TimetableCoursePanel from '@web/components/timetable/TimetableCoursePanel.vue'
import TimetableDragPopover from '@web/components/timetable/TimetableDragPopover.vue'
import ICalExportDialog from '@web/components/timetable/ICalExportDialog.vue'
import { WEEKDAYS } from '@web/constants/timetable'
import { useAlertsStore, useDragStore, useTimetableStore } from '@web/stores'
