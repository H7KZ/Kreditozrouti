...
import CourseInfo from '@web/components/courses/CourseInfo.vue'
import UnitSelector from '@web/components/courses/UnitSelector.vue'
import { useCourseLabels, useTimeUtils } from '@web/composables'
import { useCoursesStore, useFiltersStore, useTimetableStore, useUIStore } from '@web/stores'
import { fetchCourses } from '@web/services/courseService'
