...
import type { ICalCourseConfig } from '@web/utils/ical'
import { computed, ref, watch } from 'vue'
import { useI18n } from 'vue-i18n'
import { getDefaultSemesterDates, useICalExport } from '@web/composables'
import { useWizardStore } from '@web/stores'
