...
import { isMergedUnit, useCourseLabels, useScheduleExport, useShareTimetable, useSlotMerging } from '@web/composables'
...
import { useAlertsStore, useTimetableStore } from '@web/stores'
