...
export async function up(mysql: Kysely<any>): Promise<void> {
    ...
    await mysql.schema
        ...
        .addColumn('imageSrc', 'varchar(255)')
        .addColumn('imageAlt', 'varchar(255)')
        .addColumn('description', 'text')
        .addColumn('place', 'varchar(255)')
        .addColumn('author', 'varchar(255)')
        .addColumn('language', 'varchar(4)')
        .addColumn('registrationFrom', 'datetime')
        .addColumn('registrationUrl', 'varchar(1024)')
        .addColumn('substituteUrl', 'varchar(1024)')
        .execute()
