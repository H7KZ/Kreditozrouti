...
*Ověření souladu s interními předpisy VŠE*
...
| Čl. 21 | Bezpečnostní opatření: šifrování, řízení přístupu, hlášení incidentů | ✅ | HTTPS přes Traefik/Let's Encrypt. Tajemství v env proměnných. Parametrizované dotazy. Bearer token autentizace pro admin endpointy. Sentry monitoring. |
