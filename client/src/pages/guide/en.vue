...
useSeoMeta({
	...
	ogDescription:
		'VŠE Prague credit system, InSIS registration and Kreditožrouti explained step-by-step for international students.',
})
	...
	<div class="min-h-screen bg-(--insis-bg)" lang="en">
		...
		<main id="main-content" class="mx-auto max-w-4xl px-4 py-10">
			...
			<p class="mb-8 text-(--insis-gray-500)">
				Everything you need to know to get started at VŠE Prague — credits, campus, enrollment, and how
				to plan your timetable with Kreditožrouti.
			</p>
			...
			<section id="credits" class="mb-14" aria-labelledby="h-credits">
				...
				<p class="mb-4 text-(--insis-gray-700)">
					VŠE uses the ECTS credit system, recognised across European universities. When you enrol in a
					bachelor's programme you receive <strong>216 credit vouchers</strong> (kreditové poukázky). Each
					course costs vouchers equal to its credit value. Pass the course and the same number of credits
					is added to your account. You need <strong>180 earned credits</strong> distributed across the
				...
				<div class="mb-6 flex gap-3 rounded-lg border border-(--insis-border) bg-(--insis-surface) p-4">
					...
					<p class="text-sm text-(--insis-gray-700)">
						<strong>20-credit-per-semester rule:</strong> by the end of each semester your cumulative earned
						credits must equal at least
						<code class="rounded bg-(--insis-border) px-1">semester number × 20</code>. Fall behind and the
						shortfall is deducted from your remaining vouchers as a penalty.
					</p>
				</div>
					...
					<table class="w-full text-sm">
						...
						<tbody class="divide-y divide-(--insis-border) text-(--insis-gray-700)">
							...
							<tr>
								...
								<td class="px-4 py-2">
									Pick from a pool until you reach the required number of credits for this group.
								</td>
							</tr>
							<tr>
								...
								<td class="px-4 py-2">
									At FIS this is English — 12 credits total (4 courses × 3 cr). Varies by faculty.
								</td>
							</tr>
							<tr>
								...
								<td class="px-4 py-2">
									0 credits, costs 0 vouchers. You must complete 2 semesters during your bachelor's.
								</td>
							</tr>
							<tr>
								...
								<td class="px-4 py-2">
									Does not count toward your degree — taken on top of your required credits.
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="mb-6 flex gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4">
					...
					<p class="text-sm text-amber-800">
						<strong>VŠE special: grade 4+</strong> — if you score 50–59 points you receive 4+ and get one
						more attempt at the final exam or test within the same exam period. If the resit pushes you to
						60+, the 4+ is erased and you pass. If not (or if you skip the resit), you receive 4.
					</p>
				</div>
				...
				<div class="space-y-3">
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								FIS Videopříručky – vouchers, 180 credits and earning your degree
							</div>
						</div>
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								FIS Videopříručky – mandatory, elective, language courses and PE
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								FIS Videopříručky – point system, grades, 4+ resit mechanic
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
			...
			<section id="campus" class="mb-14" aria-labelledby="h-campus">
				...
				<div class="mb-4 grid gap-4 sm:grid-cols-2">
					<div class="rounded-lg border border-(--insis-border) bg-(--insis-surface) p-4">
						...
						<p class="text-sm text-(--insis-gray-500)">Náměstí W. Churchilla, Prague 3</p>
					...
					<div class="rounded-lg border border-(--insis-border) bg-(--insis-surface) p-4">
						...
						<p class="text-sm text-(--insis-gray-500)">Jižní Město, Prague 4</p>
						<p class="mt-2 text-sm text-(--insis-gray-700)">
							Room codes start with:
				...
				<div class="flex gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4">
					<IconAlertTriangle class="mt-0.5 h-5 w-5 shrink-0 text-amber-600" aria-hidden="true" />
					<p class="text-sm text-amber-800">
						<strong>Watch out for commuting time!</strong> Getting between Žižkov and Jižní Město takes
						about <strong>45 minutes</strong> by public transport. Never schedule classes on different
						campuses back-to-back — you will not make it in 15 minutes.
					</p>
				</div>
			</section>
			...
			<section id="enrollment" class="mb-14" aria-labelledby="h-enrollment">
				<div class="mb-4 flex items-center gap-2">
					...
					<h2 id="h-enrollment" class="text-2xl font-bold text-(--insis-gray-900)">
						3. Registration &amp; Enrollment
					</h2>
				</div>

				<p class="mb-6 text-(--insis-gray-700)">
					Courses are not enrolled in a single step — there are two separate phases before each semester
					begins. Exact dates are published in the academic calendar on the VŠE website.
				</p>
				...
				<ol class="mb-6 space-y-6">
					<li class="flex gap-4">
						...
						<div>
							...
							<p class="text-(--insis-gray-700)">
								You express interest in courses and pick your preferred lecture and seminar time slots.
								Over-subscription is allowed at this stage — the system resolves conflicts later.
							</p>
						</div>
					</li>
					<li class="flex gap-4">
					...
					<li class="flex gap-4">
						...
						<div>
							...
							<p class="text-(--insis-gray-700)">
								After automated enrollment you can manually adjust your timetable — swap time slots or
								instructors while seats remain available. First-come, first-served. In
				...
				<div class="mb-6 flex gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4">
					<IconAlertTriangle class="mt-0.5 h-5 w-5 shrink-0 text-amber-600" aria-hidden="true" />
					<p class="text-sm text-amber-800">
						<strong>First-years:</strong> Your first-semester timetable is pre-assigned by the faculty —
						you have a guaranteed seat. If you change a pre-assigned seminar time or drop the course during
						the registration phase, you lose that guarantee. Make timetable changes during the manual
						enrollment phase instead.
					</p>
				</div>
				...
				<div class="mb-6 flex gap-3 rounded-lg border border-(--insis-border) bg-(--insis-surface) p-4">
					<IconInfo class="mt-0.5 h-5 w-5 shrink-0 text-(--insis-blue)" aria-hidden="true" />
					<p class="text-sm text-(--insis-gray-700)">
						<strong>First-year exception:</strong> In semester 1 your mandatory courses are already
						enrolled. You only need to self-register PE and language courses — see the InSIS walkthrough
						below.
					</p>
				</div>
				...
				<div class="space-y-3">
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								FIS Videopříručky – how registration works, priorities, manual enrollment
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
			...
			<section id="tool" class="mb-14" aria-labelledby="h-tool">
				...
				<p class="mb-6 text-(--insis-gray-700)">
					Kreditožrouti helps you plan your timetable <em>before</em> enrollment opens in InSIS. It is a
					planning tool only — it does not register you for courses. Actual enrollment happens in InSIS.
				</p>
				...
				<ol class="space-y-10">
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								On first launch the setup wizard asks you to choose the faculty you study or plan to study
								at.
							</p>
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Pick the academic year you started studying. If unsure, check your e-index in InSIS or
								look at the academic year of your first enrolled semester.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/kreditozrouti_step_2.png"
									alt="Step 2 – select entry year"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Filter by study level (Bachelor's / Master's) or search by name, then click your plan. If
								your programme has a specialisation, select it here.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/kreditozrouti_step_3.png"
									alt="Step 3 – select study plan"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Check off courses you have already passed — they will be hidden from the main list so you
								can focus on what's left. This step is optional but greatly improves clarity.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/kreditozrouti_step_4_select.png"
									alt="Step 4 – mark completed courses"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Courses relevant to your study plan appear with their time slots, ECTS values and
								instructor. Click any row to see course details.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/kreditozrouti_courses.png"
									alt="Kreditožrouti – course list"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Use the left sidebar to filter by day, language, faculty or course category. Filters
								stack — for example: English + Friday = English-taught courses on Fridays.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/kreditozrouti_courses_filter.png"
									alt="Kreditožrouti – course filters"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								The timetable view shows your week as a grid. Conflicts are highlighted in red. Check
								that no two consecutive classes are on different campuses.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
			...
			<section id="insis" class="mb-14" aria-labelledby="h-insis">
				<div class="mb-4 flex items-center gap-2">
					...
					<h2 id="h-insis" class="text-2xl font-bold text-(--insis-gray-900)">
						5. Registering Courses in InSIS
					</h2>
				</div>

				<p class="mb-6 text-(--insis-gray-700)">
					Once your timetable is planned in Kreditožrouti, head to InSIS to officially enrol. InSIS's
					interface is in Czech — the captions below explain the key labels.
				</p>
				...
				<ol class="space-y-10">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								...
								<a href="https://insis.vse.cz" target="_blank" rel="noopener" class="text-(--insis-blue) underline"
									>insis.vse.cz</a
								>, sign in with your VŠE credentials, then click <strong>Portál studenta</strong>
								(= Student Portal) in the top navigation.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/insis_student_view.png"
									alt="InSIS – Student Portal home"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
						...
						<div class="flex-1">
							...
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									...
									alt="InSIS – registration sheet"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
									<strong>Arch</strong> = enrollment sheet. Each row is one course.
									<strong>Stav</strong> = status (green dot = OK, red dot = time slot missing).
								</figcaption>
							</figure>
						</div>
					</li>
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Scroll down to the course groups (oP, oV, etc.), expand a group with the arrow, tick the
								courses you want, then click <strong>Přidat označené předměty</strong> (= Add selected
								courses).
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/course_added_view.png"
									alt="InSIS – courses added with status dots"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								For each course with a red dot, click <strong>Vyberte</strong> (= Select) in the
								<strong>Rozvrh</strong> (= Timetable) column. Choose lecture and seminar times, then
								confirm with <strong>Uložit</strong> (= Save).
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/course_select_unit_slots.png"
									alt="InSIS – choosing a time slot"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
									<strong>Kapacita</strong> = Capacity (enrolled / total).
									<strong>Vyberte</strong> = Select. <strong>Uložit</strong> = Save.
					...
					<li class="flex gap-4">
						...
						<div class="flex-1">
							...
							<p class="mb-3 text-(--insis-gray-700)">
								Click <strong>Zobrazení rozvrhů</strong> (= View timetable) to see your full week. Verify
								no two back-to-back classes are on different campuses.
							</p>
							<figure class="overflow-hidden rounded-lg border border-(--insis-border)">
								<img
									src="/guide/timetable.png"
									alt="InSIS – weekly timetable view"
									class="w-full"
									loading="lazy"
								/>
								<figcaption class="bg-(--insis-surface) px-4 py-2 text-sm text-(--insis-gray-500)">
									<strong>Zobrazení rozvrhů</strong> = View timetable.
									Room codes: <strong>JM…</strong> = Jižní Město campus; <strong>RB/NB/SB/IB</strong> = Žižkov campus.
								</figcaption>
							</figure>
						</div>
					</li>
				...
				<div class="mt-6 flex gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4">
					<IconAlertTriangle class="mt-0.5 h-5 w-5 shrink-0 text-amber-600" aria-hidden="true" />
					<p class="text-sm text-amber-800">
						<strong>Remember:</strong> Kreditožrouti is a planning tool only. Until you complete enrollment
						in InSIS, you are not officially registered for any courses. Kreditožrouti does not enrol
						you.
					</p>
				</div>
				...
				<div class="mt-6 space-y-3">
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								Official documentation for the Registrace a zápisy application (Czech)
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								Practical guide from VŠE IT — priorities, penalties, manual enrollment (Czech)
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
				...
				<div class="grid gap-3 sm:grid-cols-2">
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								Everything incoming exchange students need: application, visa, dorms, orientation
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								Get matched with a Czech student who can help you settle in
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">VŠE student information system</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					<a
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								Official InSIS help for new students (Czech)
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">Practical registration guide (Czech)</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
					<a
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-sm text-(--insis-gray-500)">
								Registration, enrollment and exam period dates
							</div>
						</div>
						<IconExternalLink class="h-4 w-4 shrink-0 text-(--insis-gray-400)" aria-hidden="true" />
					</a>
