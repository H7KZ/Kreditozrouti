...
Příjemci uvidí rozvrh jen pro čtení a mohou jej jedním kliknutím rozvětvit do svého vlastního rozvrhu. Platnost odkazů
trvá 180 dní od posledního zobrazení.

---

## Export do kalendáře (iCal)

Chceš mít rozvrh v Google Calendar, Apple Calendar nebo Outlooku? Exportuj svůj rozvrh jako soubor `.ics` z panelu
nástrojů **Mého rozvrhu**. Importuj jej do libovolné aplikace kalendáře, která podporuje formát iCal.
