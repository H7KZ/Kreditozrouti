            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input type="text" defaultValue="Ano" readOnly className="w-full cursor-pointer rounded-lg bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none transition-all focus:ring-2 focus:ring-blue-100" />
                </div>
              </div>
            </div>
          </div>
