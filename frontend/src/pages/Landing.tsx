    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-900 p-4">
      ...
      <Card className="w-full max-w-sm border-none shadow-none bg-white">
        <CardHeader className="text-center pb-8 pt-12">
          ...
          <CardTitle className="text-2xl font-semibold text-black leading-snug">
            Připoj se pomocí svého školního e-mailu
          </CardTitle>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-[#00A753] hover:bg-[#009249] text-white text-base font-semibold py-6 mt-4"
              >
                Poslat potvrzení
              </Button>
              ...
              <div className="text-center mt-2">
                <a 
                  href="#" 
                  onClick={(e) => { e.preventDefault(); console.log("Code received clicked"); }}
